...
@section('content')
      ...
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
          <div class="row">
            ...
            <div class="col-md-6">
              <img src="{{ asset('assets/img/hp/anyshare-interface.jpg') }}" class="product-image">
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="uses-section">
    <div class="container uses-container">
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
          <h2 class="text-center white-secondary-heading" style="text-align:center;">What can you do?</h2>
      ...
      * How you use a Sharing Website is limited only by your imagination!
      </div>
    </div>
  </section>
  ...
  <section class="cta">
    <div class="container">
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
          <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 margin-bottom-0">
              <h2 class="white-secondary-heading">Make your own Sharing Website</h2>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-12  margin-bottom-0">
              <a href="{{ route('community.create.form') }}" class="w-button cta-button contained-button pull-right" style="width:100%">{{ trans('general.nav.start_now') }}</a>
            </div>
          </div>
        </div>
      </div>
