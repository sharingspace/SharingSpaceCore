              ...
              <h2 class="size-16 uppercase">Payment Information</h2>
                ...
                <!-- Billing Email -->
                  ...
                  <div class="form-group col-md-12 payment-errors alert alert-mini alert-danger margin-bottom-10" style="display: none; margin-left: 15px;">
                      ...
                      <div class="form-group col-md-3 col-sm-2" id="form-card-month">
                      ...
                      <div class="form-group col-md-3 col-sm-3" id="form-card-year">
                          ...
                          <input id="exp_year" type="text" class="form-control required card-expiry-year" placeholder="{{ (date('Y') + 3) }}"  data-stripe="exp-year" />
    									...
    									<div class="form-group col-md-3 col-sm-3" id="form-card-cvc">
