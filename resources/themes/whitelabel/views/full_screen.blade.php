...
<div class="full-screen">
    ...
    <section class="margin-y-0 padding-y-0">
        <!-- Begin entries grid -->
        <div id="entry_browse_grid" class="grid">
            <div class="grid-item clone hidden">
            </div>
        </div>
        <!-- End entries grid -->
        <!-- Begin entries map -->
    @include('partials.map', ['size' => '850'])
    <!-- End entries map -->
    </section>
