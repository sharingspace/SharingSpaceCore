...
class SuperAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            ['first_name' => 'Vanderlei', 'last_name' => 'Amancio', 'display_name' => 'Harry', 'email' => 'harry@massmosaic.com', 'password' => bcrypt('secret'), 'superadmin' => 1, 'created_at' => Carbon::now()->format('Y-m-d H:i:s')]
        ]);
    }
}
