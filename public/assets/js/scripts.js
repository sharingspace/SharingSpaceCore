...
function _topNav () {
    ...
    jQuery('li.search i.fa').click(function () {
        if (jQuery('#header .search-box').is(":visible")) {
            ...
            if (jQuery('#header li.notifications-popdown div.notifications-popdown-box').is(":visible")) {
                jQuery('#header li.notifications-popdown div.notifications-popdown-box').fadeOut(300);
            }
        }
    });
    ...
    // Quick Cart
    jQuery('li.notifications-popdown>a').click(function (e) {
        e.preventDefault();

        var _quick_cart_box = jQuery('li.notifications-popdown div.notifications-popdown-box');
    ...
    if (jQuery('li.notifications-popdown>a').size() != 0) {
        jQuery('li.notifications-popdown').on('click', function (e) {
            e.stopPropagation();
        });

        jQuery('body').on('click', function () {
            if (jQuery('li.notifications-popdown div.notifications-popdown-box').is(":visible")) {
                jQuery('li.notifications-popdown div.notifications-popdown-box').fadeOut(300);
            }
        });
    }
    ...
    jQuery(window).scroll(function () {
        if (window.width < 769) {
            // hide quick cart if visible
            if (jQuery('#header li.notifications-popdown div.notifications-popdown-box').is(":visible")) {
                jQuery('#header li.notifications-popdown div.notifications-popdown-box').fadeOut(0);
            }
...
;window.Modernizr = function (a, b, c) {
    ...
    var d = "2.7.1", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k, l = {}.toString, m = " -webkit- -moz- -o- -ms- ".split(" "), n = "Webkit Moz O ms", o = n.split(" "),
    ...
    return e.addTest = function (a, b) {
        ...
        var c = "3.7.0", d = a.html5 || {}, e = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, f = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, g,
            h = "_html5shiv", i = 0, j = {}, k;
        (function () {
            try {
    ...
    var l = b.documentElement, m = a.setTimeout, n = b.getElementsByTagName("script")[0], o = {}.toString, p = [], q = 0, r = "MozAppearance" in l.style, s = r && !!b.createRange().compareNode, t = s ? l : n.parentNode,
        l = a.opera && "[object Opera]" == o.call(a.opera), l = !!b.attachEvent && !l, u = r ? "object" : l ? "script" : "img", v = l ? "script" : u, w = Array.isArray || function (a) {
