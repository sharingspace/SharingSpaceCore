...
Webflow.require('ix').init([
  {"slug":"nav-bar-color","name":"nav bar color","value":{"style":{"title":"transparent"},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"height":"100%","transition":"opacity 500ms ease 0ms, height 500ms ease 0ms"}],"stepsB":[]}]}}
]);
